...
import com.recodecommerce.chatandbuy.adapter.MessageAdapter;
...
public class MessagingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get current User Id
        currentUserId = Config.USER_EMAIL;
    ...
    //method to populate messages history, to be implemented once Rails backend messaging model is figured out
/*
    ...
    private class MyMessageClientListener implements MessageClientListener {
        ...
        public void onIncomingMessage(MessageClient client, final Message message) {
            Log.d("Man", "we do have an incoming message");
