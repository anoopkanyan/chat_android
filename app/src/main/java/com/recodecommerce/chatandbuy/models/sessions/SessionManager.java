package com.recodecommerce.chatandbuy.models.sessions;
...
import com.recodecommerce.chatandbuy.activities.LoginActivity;
...
public class SessionManager {
    ...
    private static final String PREF_NAME = "ChatAndBuy";
    ...
    public void checkLogin() {
        ...
        if (!this.isLoggedIn()) {
            ...
            serviceIntent = new Intent(_context, MessageService.class);
